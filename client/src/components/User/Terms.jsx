  ...
  return (
    ...
    >
      ...
      <div className="w-full py-8 px-4 sm:py-12 sm:px-6 md:py-16 lg:py-20">
        <div 
          className="max-w-4xl z-10 mx-auto px-6 py-10 sm:px-10 md:px-16 md:py-16 bg-gradient-to-b from-purple-600/2 to-transparent backdrop-blur-sm border rounded-xl"
          style={{
        ...
        >
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-[URW-bold] font-bold text-purple-700 mt-6 md:mt-8 pb-3 mb-4 md:mb-6 border-b border-gray-700">About Safire</h2>
            <p className="font-[futura] text-white text-sm sm:text-base md:text-md mb-8 md:mb-16">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-[URW-bold] font-bold text-purple-700 mt-6 md:mt-8 pb-3 mb-4 md:mb-6 border-b border-gray-700">Data Privacy & Security</h2>
